...
import sys
import json
from bot import enviar_alerta_80_100, create_pool, ultimos_valores, alertas_enviados, hora_media_alerta_1_80, hora_media_alerta_1_100, hora_media_alerta_80_100_saida, sem_mensagem_silenciado
import aiomysql
...
async def main():
    ...
    await enviar_alerta_80_100(cod_equipamentos, tabelas, cod_campo_especificados, pool)
